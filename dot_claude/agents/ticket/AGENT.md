---
name: ticket
description: Drafts ServiceNow tickets (change requests, incidents, service requests)
...
- Use headers for each field that needs to be filled out. These will not be copied.
